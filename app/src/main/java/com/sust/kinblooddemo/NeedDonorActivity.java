...
public class NeedDonorActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText searchLocation = findViewById(R.id.activity_need_donor_searchMap_EditText);
        ...
        searchLocation.setOnClickListener(view -> {
            ...
            Intent intent = new Autocomplete.IntentBuilder(AutocompleteActivityMode.OVERLAY, fieldList).build(NeedDonorActivity.this);
