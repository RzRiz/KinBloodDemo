...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                R.id.navigation_bloodInfo, R.id.navigation_requestStatus)
                .build();
        ...
        needDonor.setOnClickListener(view -> {
            startActivity(new Intent(MainActivity.this, NeedDonorActivity.class));
        ...
        request.setOnClickListener(view -> {
            startActivity(new Intent(MainActivity.this, AfterNotifMap.class));
            drawerLayout.closeDrawer(GravityCompat.START);
        });
